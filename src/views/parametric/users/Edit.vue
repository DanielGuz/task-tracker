      ...
      <div class="hero m-0 py-4" style="height: calc(100% - 90px);">
        <tt-ui-form-container simple>
          ...
          >
            ...
            >
              <b-input v-bind="field" maxlength="40" placeholder="Ingrese un apellido para el usuario"/>
            </b-field>
          </VeeField>
          ...
          >
            ...
            >
              <b-input v-bind="field" maxlength="10" placeholder="Ingrese el número de documento del usuario"/>
            </b-field>
          </VeeField>
          ...
          >
            ...
            >
              <b-input v-bind="field" maxlength="100" placeholder="Ingrese el usuario"/>
            </b-field>
          </VeeField>
          ...
          >
            <b-field
                ...
                :type="{ 'is-danger': errors.clave, 'is-success': validate }"
            >
              <b-input v-bind="field" maxlength="1000" placeholder="Ingrese la clave"/>
            </b-field>
          </VeeField>
